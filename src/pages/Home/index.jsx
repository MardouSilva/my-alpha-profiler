...
export const Home = () => {
  ...
  return React.createElement(
    ...
    React.createElement("div", { id: "infoContainer" }, [
      React.createElement("div", { id: "blueCardsContainer" }, [
        React.createElement("div", { className: "blueCards" }, [
          React.createElement("p", { className: "cardTitle" }, "Nome"),
          React.createElement("p", { className: "blueCardTextContent" }, userInfo.username),
        ]),
        React.createElement("div", { className: "blueCards" }, [
          React.createElement("p", { className: "cardTitle" }, "Idade"),
          React.createElement("p", { className: "blueCardTextContent" }, getAge()),
        ]),
      ]),
      React.createElement("div", { id: "violetCardsContainer" }, [
        React.createElement("div", { className: "violetCards" }, [
          React.createElement("p", { className: "cardTitle" }, "Nome"),
          React.createElement("p", { className: "violetCardTextContent" }, userInfo.birth_date),
        ]),
        React.createElement("div", { className: "violetCards" }, [
          React.createElement("p", { className: "cardTitle" }, "Idade"),
          React.createElement("p", { className: "violetCardTextContent" }, userInfo.email),
        ]),
      ]),
      React.createElement("img", { className: "imageUser", src: "https://i.pinimg.com/564x/8b/da/ca/8bdaca81d5ddbaeb92b61d6b5787d866.jpg", alt: "UserPerfil" }),
    ])
  );
